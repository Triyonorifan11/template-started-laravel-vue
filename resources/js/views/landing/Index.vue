                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <div class="d-flex align-items-center flex-equal">
                                ...
                                <a href="../../demo1/dist/landing.html">
                                    <img alt="Logo" :src="$assetUrl()+'media/logos/logo-landing.svg'"
                                        class="logo-default h-25px h-lg-30px" />
                                    <img alt="Logo" :src="$assetUrl()+'media/logos/logo-landing-dark.svg'"
                ...
                <div class="d-flex flex-column flex-center w-100 min-h-350px min-h-lg-500px px-9">
                    ...
                    <div class="d-flex flex-center flex-wrap position-relative px-5">
                        ...
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Fujifilm">
                            <img :src="$assetUrl() + 'media/svg/brand-logos/fujifilm.svg'" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Vodafone">
                            <img :src="$assetUrl() + 'media/svg/brand-logos/vodafone.svg'" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="KPMG International">
                            <img :src="$assetUrl() + 'media/svg/brand-logos/kpmg.svg'" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Nasa">
                            <img :src="$assetUrl() + 'media/svg/brand-logos/nasa.svg'" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Aspnetzero">
                            <img :src="$assetUrl() + 'media/svg/brand-logos/aspnetzero.svg'" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip"
                            title="AON - Empower Results">
                            <img :src="$assetUrl() + 'media/svg/brand-logos/aon.svg'" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Hewlett-Packard">
                            <img :src="$assetUrl() + 'media/svg/brand-logos/hp-3.svg'" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                        <!--begin::Client-->
                        <div class="d-flex flex-center m-3 m-md-6" data-bs-toggle="tooltip" title="Truman">
                            <img :src="$assetUrl() + 'media/svg/brand-logos/truman.svg'" class="mh-30px mh-lg-40px" alt="" />
                        </div>
                        <!--end::Client-->
                    </div>
                    <!--end::Clients-->
                ...
                <div class="row w-100 gy-10 mb-md-20">
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img :src="$assetUrl() + 'media/illustrations/sketchy-1/2.png'" class="mh-125px mb-9" alt="" />
                            <!--end::Illustration-->
                            <!--begin::Heading-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img :src="$assetUrl() + 'media/illustrations/sketchy-1/8.png'" class="mh-125px mb-9" alt="" />
                            <!--end::Illustration-->
                            <!--begin::Heading-->
                            <div class="d-flex flex-center mb-5">
                                <!--begin::Badge-->
                    ...
                    <div class="col-md-4 px-5">
                        ...
                        <div class="text-center mb-10 mb-md-0">
                            <!--begin::Illustration-->
                            <img :src="$assetUrl() + 'assets/media/illustrations/sketchy-1/12.png'" class="mh-125px mb-9" alt="" />
                            <!--end::Illustration-->
                            <!--begin::Heading-->
                            <div class="d-flex flex-center mb-5">
                                <!--begin::Badge-->
                ...
                <div class="tns tns-default">
                    ...
                    <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                        ...
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img :src="$assetUrl() + 'assets/media/product-demos/demo1.png'" class="card-rounded shadow mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img :src="$assetUrl() + 'assets/media/product-demos/demo2.png'" class="card-rounded shadow mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img :src="$assetUrl() + 'assets/media/product-demos/demo4.png'" class="card-rounded shadow mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                        <!--begin::Item-->
                        <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                            <img :src="$assetUrl() + 'assets/media/product-demos/demo5.png'" class="card-rounded shadow mw-100" alt="" />
                        </div>
                        <!--end::Item-->
                    </div>
                    <!--end::Slider-->
                    ...
                    <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false" data-tns-speed="2000"
                        ...
                        <div class="text-center">
                            ...
                            <div class="octagon mx-auto mb-5 d-flex w-200px h-200px bgi-no-repeat bgi-size-contain bgi-position-center"
                                :style="'background-image:url('+ $assetUrl() + 'media/avatars/150-2.jpg);'"></div>
                            <!--end::Photo-->
                            <!--begin::Person-->
                            <div class="mb-0">
                                <!--begin::Name-->
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                ...
                                <div class="symbol symbol-circle symbol-50px me-5">
                                    <img :src="$assetUrl() + 'media/avatars/150-2.jpg'" class="" alt="" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                    ...
                    <div class="col-lg-4">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-circle symbol-50px me-5">
                                    <img :src="$assetUrl() + 'media/avatars/150-3.jpg'" class="" alt="" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <div class="flex-grow-1">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div
                            ...
                            <div class="d-flex align-items-center">
                                <!--begin::Avatar-->
                                <div class="symbol symbol-circle symbol-50px me-5">
                                    <img :src="$assetUrl() + 'media/avatars/150-18.jpg'" class="" alt="" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Name-->
                                <div class="flex-grow-1">
                        ...
                        <div class="col-lg-6 ps-lg-16">
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <div class="d-flex fw-bold flex-column ms-lg-20">
                                    ...
                                    <!--begin::Link-->
                                    <a href="#" class="mb-6">
                                        <img :src="$assetUrl() + 'media/svg/brand-logos/facebook-4.svg'" class="h-20px me-2"
                                            alt="" />
                                    ...
                                    <!--begin::Link-->
                                    <a href="#" class="mb-6">
                                        <img :src="$assetUrl() + 'media/svg/brand-logos/github.svg'" class="h-20px me-2" alt="" />
                                        <span class="text-white opacity-50 text-hover-primary fs-5 mb-6">Github</span>
                                    </a>
                                    <!--end::Link-->
                                    <!--begin::Link-->
                                    <a href="#" class="mb-6">
                                        <img :src="$assetUrl() + 'media/svg/brand-logos/twitter.svg'" class="h-20px me-2"
                                            alt="" />
                                    ...
                                    <!--begin::Link-->
                                    <a href="#" class="mb-6">
                                        <img :src="$assetUrl() + 'media/svg/brand-logos/dribbble-icon-1.svg'" class="h-20px me-2"
                                            alt="" />
                                    ...
                                    <!--begin::Link-->
                                    <a href="#" class="mb-6">
                                        <img :src="$assetUrl() + 'assets/media/svg/brand-logos/instagram-2-1.svg'" class="h-20px me-2"
                                            alt="" />
                                        <span
                ...
                <div class="container">
                    ...
                    <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                        ...
                        <div class="d-flex align-items-center order-2 order-md-1">
                            <!--begin::Logo-->
                            <a href="../../demo1/dist/landing.html">
                                <img alt="Logo" :src="$assetUrl() + 'media/logos/logo-landing.svg'" class="h-15px h-md-20px" />
                            </a>
                            <!--end::Logo image-->
                            <!--begin::Logo image-->
                    ...
                    <div class="text-white">
                        {{ $moment().format('dddd, DD MMMM YYYY') }} {{ currentTime }} WIB
                    </div>
                    <!--end::Wrapper-->
                </div>
                <!--end::Container-->
...
export default {
    data() {
        return {
            backgroundStyle: {
                backgroundImage: `url('${this.$assetUrl()}media/svg/illustrations/landing.svg')`,
            ...
            CONSUMER: env('VITE_ROLE_CONSUMER', 'customer2'),
            DEVELOPER: globalConfig.role.developer,
            ROLE_REVIEWER: globalConfig.role.reviewer,
            intervalId: null,
            currentTime: this.$moment().locale('id').format('LTS')
        };
    },
    mounted() {
        this.intervalId = setInterval(() => {
            this.currentTime = this.$moment().locale('id').format('LTS')
        }, 1000);
    },
    computed: {
    },
