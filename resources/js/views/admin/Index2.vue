<template>
	<!-- <router-view class="router-admin"></router-view> -->
					...
					<div class="aside-toolbar flex-column-auto" id="kt_aside_toolbar">
						...
						<div class="aside-user d-flex align-items-sm-center justify-content-center py-5">
							...
							<div class="symbol symbol-50px">
								<img :src="$assetUrl() + 'media/avatars/150-26.jpg'" alt="" />
							</div>
							<!--end::Symbol-->
							<!--begin::Wrapper-->
											...
											<div class="menu-item px-3">
												<div class="menu-content d-flex align-items-center px-3">
													...
													<div class="symbol symbol-50px me-5">
														<img alt="Logo" :src="$assetUrl() + 'media/avatars/150-26.jpg'" />
													</div>
													<!--end::Avatar-->
													<!--begin::Username-->
					...
					<div id="kt_header" style="" class="header align-items-stretch">
						...
						<div class="header-brand">
							...
							<a href="../../demo8/dist/index.html">
								<img alt="Logo" :src="$assetUrl() + 'media/logos/logo-1-dark.svg'" class="h-25px h-lg-25px" />
							</a>
							<!--end::Logo-->
														...
														<div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
															...
															<div class="d-flex flex-column px-9">
																...
																<div class="text-center px-4">
																	<img class="mw-100 mh-200px" alt="image" :src="$assetUrl() + 'media/illustrations/sketchy-1/1.png'" />
																</div>
																<!--end::Illustration-->
															</div>
															<!--end::Wrapper-->
																...
																<tbody>
																		...
																		<td>
																			<div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img :src="$assetUrl() + 'media/svg/brand-logos/plurk.svg'" class="h-50 align-self-center" alt="" />
																				</span>
																			</div>
																		</td>
																		<td>
																	...
																	<tr>
																		<td>
																			<div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img :src="$assetUrl() + 'media/svg/brand-logos/telegram.svg'" class="h-50 align-self-center" alt="" />
																				</span>
																			</div>
																		</td>
																		<td>
...
<script>
import appAdminNavbar from '@/components/templates/Navbar.vue';
import appAdminSidebar from '@/components/templates/Sidebar.vue';
export default {
	components: {
		appAdminNavbar,
		appAdminSidebar,
